...
export { ListadoPedidosPage } from './listado-pedidos/listado-pedidos';
export { ListadoNegociosPage } from './listado-negocios/listado-negocios';
export { ListadoClientesPage } from './listado-clientes/listado-clientes';
export { RegistroProductoPage } from './registro-producto/registro-producto';
